...
.stApp {
    background: linear-gradient(160deg, #071a09 0%, #0d2b12 60%, #0f3016 100%);
    min-height: 100vh;
}
...
.hero-badge {
    ...
    background: rgba(134,239,92,0.1);
...
.hero h1 {
    ...
    font-weight: 800; color: #f0fdf0; line-height: 1.1; margin: 0 0 10px;
}
...
.steps-row {
    ...
    flex-wrap: wrap; margin: 1.8rem auto; max-width: 860px;
}
.step-card {
    background: rgba(255,255,255,0.04);
    border: 1px solid rgba(134,239,92,0.12);
    border-radius: 14px; padding: 14px 18px; flex: 1; min-width: 160px; max-width: 220px;
}
.step-num {
    font-family: 'Syne', sans-serif; font-size: 1.6rem;
    font-weight: 800; color: rgba(134,239,92,0.35); margin-bottom: 4px;
}
...
.metrics-row {
    ...
    flex-wrap: wrap; margin: 1.2rem auto 1.8rem; max-width: 700px;
}
.metric-card {
    background: rgba(255,255,255,0.05);
    border: 1px solid rgba(134,239,92,0.18);
    border-radius: 14px; padding: 14px 24px; text-align: center; min-width: 140px;
}
.metric-val {
    font-family: 'Syne', sans-serif; font-size: 2rem;
    font-weight: 800; color: #86ef5c; line-height: 1;
}
.metric-lbl {
    font-size: 0.68rem; letter-spacing: 0.1em; text-transform: uppercase;
    color: rgba(210,252,210,0.38); margin-top: 4px;
}

.upload-wrap { max-width: 660px; margin: 0 auto 2rem; }
[data-testid="stFileUploader"] {
    background: rgba(255,255,255,0.025) !important;
    border: 2px dashed rgba(134,239,92,0.28) !important;
...
.rc {
    ...
    border: 1px solid rgba(134,239,92,0.1);
...
.count-pill {
    background: #86ef5c; color: #071a09;
    font-family: 'Syne', sans-serif; font-weight: 800; font-size: 0.78rem;
    padding: 3px 12px; border-radius: 999px;
}
.img-lbl {
    font-size: 0.65rem; letter-spacing: 0.12em; text-transform: uppercase;
    color: rgba(210,252,210,0.35); margin-bottom: 5px;
}

.total-banner {
    background: linear-gradient(90deg, rgba(134,239,92,0.14), rgba(134,239,92,0.04));
    border: 1px solid rgba(134,239,92,0.3);
    border-radius: 18px; padding: 1.6rem 2rem;
    text-align: center; margin: 0.5rem auto 2rem; max-width: 420px;
}
...
if uploaded_files:
    ...
    <div class="metrics-row">
      ...
      <div class="metric-card">
        <div class="metric-val">{n_imgs}</div>
    ...
    st.markdown('<hr class="divider">', unsafe_allow_html=True)
    st.markdown(
        "<h3 style='font-family:Syne,sans-serif;color:#d1fad1;font-size:1.1rem;margin-bottom:1rem;'>"
